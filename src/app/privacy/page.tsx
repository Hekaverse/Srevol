        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-8 text-warm-white/60 leading-relaxed">
            <section>
              ...
              <p>We collect information you provide directly to us, including your name, email address, partner&apos;s email address, password, travel preferences, and payment information. We also collect usage data and cookies to improve your experience.</p>
            </section>

            <section>
              <h2 className="font-serif text-xl font-bold text-warm-white mb-3">2. How We Use Your Information</h2>
              <p>We use your information to provide and improve our services, process payments, communicate with you about your bookings, send marketing communications (with your consent), and comply with legal obligations.</p>
            </section>

            <section>
              <h2 className="font-serif text-xl font-bold text-warm-white mb-3">3. Data Sharing</h2>
              <p>We do not sell your personal data. We share data only with trusted service providers (payment processors, travel partners) who need it to perform services on our behalf, and when required by law.</p>
            </section>
